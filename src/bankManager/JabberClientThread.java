...
public class JabberClientThread  {
	...
	static class BankBranch extends JFrame implements Observer {
	    ...
	    private void initComponents() {
	        ...
	        currencyOpperations1 = new CurrencyOpperations(bankAccess);
	        ...
	        jTabbedPane1.addTab("Currency", currencyOpperations1);
	...
	//        jMenuItem4.setText("Operations");
	    ...
	    private CurrencyOpperations currencyOpperations1;
	...
	/**
	 * 
	 * @author nataliakiselyk
	 *
	 */
	static class CurrencyOpperations extends JPanel implements Observer {

	    /**
	     * Creates new form SpecificClient
	     */
	    public CurrencyOpperations(BankAccess bank) {
	    	this.access = bank;
	    	this.access.addObserver(this);
	        initComponents();
	        this.jTabbedPane1.setVisible(false);
	    ...
	    private void initComponents() {
	        ...
	        jButton1.addActionListener(new ActionListener(){
				...
				{
				buyCurrency = new BuyCurrencyPanel(access,pass, lastName,firstName);
				sellCurrency = new SellCurrencyPanel(access,pass, lastName,firstName);
				
				//
			
		        jTabbedPane1.addTab("Buy Currency", buyCurrency);
		        jTabbedPane1.addTab("Sell Currency", sellCurrency);
		       
		       //
				}
				else
				{
					buyCurrency.setNewInfo(firstName, lastName, pass);
					sellCurrency.setNewInfo(firstName, lastName, pass);
				}
				access.getInfo(lastName, firstName, pass);	
				}});
	...
	//    private InfoPanel infoPanel1;
	    ...
	    private JPasswordField passField;
	  //  private WithdrawPnl withdrawPnl1;
	    private SellCurrencyPanel sellCurrency;
	    private BuyCurrencyPanel buyCurrency;
	 ...
	 * @author natalia
	 */
	static class TakeCreditPanel extends javax.swing.JPanel implements Observer {

    /**
     * Creates new form InfoPanel
     */
    public TakeCreditPanel(BankAccess bank) {
    	this.access = bank;
    	this.access.addObserver(this);
        initComponents();
    }
	 ...
	 * @author natalia
	 */
	static class SellCurrencyPanel extends JPanel implements Observer {

	    /**
	     * Creates new form Buy Currency Panel
	     */
	    public SellCurrencyPanel(BankAccess bank,String password, String lN,String fN) {
	    	this.lastName = lN;
	    	this.firstName = fN;
	    	this.password = password;
	    	this.access = bank;
	    ...
	    private void initComponents() {
	        ...
	        jLabel1 = new JLabel();
	        sellCurrencyField = new JTextField();
	        sellCurrencyButton = new JButton();
	        sellCurrencyButton.addActionListener(new ActionListener(){

				@Override
				public void actionPerformed(ActionEvent e) {
					try
					{
						int moneySum = Integer.valueOf(sellCurrencyField.getText());
						sellCurrencyField.setText("");
						if(moneySum <= 0) return;
						access.addMoney(lastName, firstName, password, moneySum);
						access.getInfo(lastName, firstName, password);
					}
	        ...
	        jLabel1.setFont(new java.awt.Font("Luminari", 1, 14)); // NOI18N
	        jLabel1.setText("Sell Currency");

	        sellCurrencyButton.setFont(new java.awt.Font("Luminari", 2, 13)); // NOI18N
	        sellCurrencyButton.setText("Perform");
	        ...
	        layout.setHorizontalGroup(
	            ...
	            .addGroup(layout.createSequentialGroup()
	                ...
	                .addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE)
	                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
	                .addComponent(sellCurrencyField, GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
	                .addContainerGap())
	            .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
	                .addGap(0, 0, Short.MAX_VALUE)
	                .addComponent(sellCurrencyButton, GroupLayout.PREFERRED_SIZE, 114, GroupLayout.PREFERRED_SIZE))
	        );
	        layout.setVerticalGroup(
	            layout.createParallelGroup(GroupLayout.Alignment.LEADING)
	            .addGroup(layout.createSequentialGroup()
	                ...
	                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
	                    .addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
	                    .addComponent(sellCurrencyField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
	                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
	                .addComponent(sellCurrencyButton, GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE))
	        );
	    }// </editor-fold>//GEN-END:initComponents
	    ...
	    private JTextField sellCurrencyField;
	    private JLabel jLabel1;
	    // End of variables declaration//GEN-END:variables
		@Override
		public void update(Observable o, Object arg) {
				...
				public void run() {
					if(finalArg != null)
					{
						if(finalArg.toString().startsWith("RESPAddmoney"))
						{
							if(finalArg.toString().contains("OK"))
							{
								JOptionPane.showMessageDialog(null, "Money in currency was added to your account");
								
							}
							else if(finalArg.toString().contains("F"))
							{
								JOptionPane.showMessageDialog(null, "Problems occurred while adding money to client account");
							}
						}
					}
				}});	
	 ...
	 * @author natalia
	 */
	static class BuyCurrencyPanel extends javax.swing.JPanel implements Observer {
		/**
	     * Creates new form Buy Currency Panel
	     */
	    public BuyCurrencyPanel(BankAccess bank,String password, String lN,String fN) {
	    	this.lastName = lN;
	    	this.firstName = fN;
	    	this.password = password;
	    	this.access = bank;
	    ...
	    private void initComponents() {
	        ...
	        jLabel1 = new JLabel();
	        jLabel2 = new JLabel();
	        buyCurrencyField = new JTextField();
	        buyCurrencyButton = new JButton();
	        buyCurrencyButton.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
					try
					{
						int moneySum = Integer.valueOf(buyCurrencyField.getText());
						buyCurrencyField.setText("");
						if(moneySum <= 0) return;
						access.addMoney(lastName, firstName, password, moneySum);
						access.getInfo(lastName, firstName, password);
					}
	        ...
	        jLabel1.setFont(new java.awt.Font("Luminari", 1, 14)); // NOI18N
	        jLabel1.setText("Buy Currency");
	        jLabel2.setText("Avaliable only USD");
	        buyCurrencyButton.setFont(new java.awt.Font("Luminari", 2, 13)); // NOI18N
	        buyCurrencyButton.setText("Perform");
	        ...
	        layout.setHorizontalGroup(
	            ...
	            .addGroup(layout.createSequentialGroup()
	                ...
	                .addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE)
	                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
	                .addComponent(buyCurrencyField, GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
	                .addContainerGap())
	            .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
	                .addGap(0, 0, Short.MAX_VALUE)
	                .addComponent(buyCurrencyButton, GroupLayout.PREFERRED_SIZE, 114, GroupLayout.PREFERRED_SIZE))
	        );
	        layout.setVerticalGroup(
	            layout.createParallelGroup(GroupLayout.Alignment.LEADING)
	            .addGroup(layout.createSequentialGroup()
	                ...
	                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
	                    .addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
	                    .addComponent(buyCurrencyField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
	                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
	                .addComponent(buyCurrencyButton, GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE))
	        );
	    }// </editor-fold>//GEN-END:initComponents
	    ...
	    private JTextField buyCurrencyField;
	    private JLabel jLabel1;
	    private JLabel jLabel2;
	    // End of variables declaration//GEN-END:variables
		@Override
